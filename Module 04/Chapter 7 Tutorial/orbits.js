...
function updateCountdown() {
	var dateToday = new Date();
	var dateFrom = Date.UTC(dateToday.getFullYear(), dateToday.getMonth(), dateToday.getDate(), dateToday.getHours(), dateToday.getMinutes(),
	...
	if ((dateTo - dateFrom) < 1000) {
		// time will be less than 0 when the interval runes next
...
function registerName() {
	...
	ticket.passengers[newFnameProp] = ticket.passengers.fName = document.getElementById("fname").value;
	ticket.passengers[newLnameProp] = ticket.passengers.lName = document.getElementById("lname").value;
	...
	//display ticcket and passengers section
