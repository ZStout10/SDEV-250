...
function validatePassword() {
   ...
   try {
	  ...
	  if (/.{8,}/.test(pw1Input.value) === false) {
		  ...
		  throw "Password must contain at least one of the following: !@#_.";
	  }
...
function validateEmail() {
   ...
   try {
	  ...
	  //if ((/@/.test(emailInput.value) === false) || (/\...$/.test(emailInput.value) === false) && (/\....$/.test(emailInput.value) === false) &&
			//(/\.....$/.test(emailInput.value) === false) && (/\.......$/.test(emailInput.value) === false)) {
